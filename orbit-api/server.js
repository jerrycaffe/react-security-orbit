...
// USING MIDDLEWARE TO SECURE APPLICATION
...
// since we want to attach our token to several request we can just call app . use so it get added to all request
// Anything below this will have the attach user middleware
app.use(attachUser);
